package org.wso2.carbon.extension.identity.authenticator.entities.cancel;
...
public class JSONObjectCancel {
	...
	public String toString() {
		return "JSONObjectCancel [reason=" + reason + ", authnAttemptId=" + authnAttemptId + ", removeAttemptId="
				+ removeAttemptId + "]";
	}
